    ...
    StepConfig(
        ...
        prompt_template=(
            ...
            + "\n".join([
                ...
                "",
                "   c) Set likely_direction: WHO acts on whom for this function?",
                "      - 'main_to_primary' = query protein acts on interactor",
                "      - 'primary_to_main' = interactor acts on query protein",
                "      - Think: If the interactor PROTECTS/STABILIZES/MODIFIES the query protein,",
                "        that's 'primary_to_main'. If the query protein MODIFIES the interactor,",
                "        that's 'main_to_primary'.",
                "      - This will be verified in Step 2c, but your initial assessment matters!",
                "",
                "   d) Write cellular_process (DETAILED molecular mechanism, 2-4 sentences):",
                "      - MUST include binding domains/residues/motifs involved",
                "      - MUST describe post-translational modifications if any",
                "      - MUST describe conformational changes or complex formation",
                "      - Reference specific protein domains (e.g., 'UbS2 domain', 'Josephin domain')",
                "      - Be SPECIFIC: 'ATXN3 binds RAD23A via its UbS2 domain on the N-terminal",
                "        Josephin domain' NOT 'ATXN3 interacts with RAD23A'",
                "",
                "   e) Write effect_description (2-3 sentences describing functional outcome):",
                "      - MUST describe what changes at the cellular level",
                "      - MUST describe downstream processes affected",
                "      - Be SPECIFIC: 'RAD23A binding shields ATXN3 from proteasomal degradation,",
                "        increasing its half-life and steady-state levels in the cell' NOT",
                "        'RAD23A affects ATXN3 stability'",
                "",
                "   f) List biological_consequence cascades (2-3 MULTI-STEP cascades with arrows →):",
                "      - Each cascade: trace from initial interaction → intermediates → physiological outcome",
                "      - Example: 'RAD23A binds ATXN3 via UbS2 → Shields from 26S proteasome →",
                "        Inhibits proteasomal degradation → Increased ATXN3 half-life →",
                "        Elevated ATXN3 protein levels'",
                "      - Include 2-3 different cascade scenarios when possible",
                "",
                "   g) List specific_effects (3-5 atomic experimental facts, NO arrows):",
                "      - Each should be a single measurable observation from the literature",
                "      - Example: 'Knockdown of Rad23 in cultured cells results in lower levels",
                "        of ataxin-3 protein'",
                "      - Example: 'Disrupting UbS2 interaction decreases ataxin-3 half-life'",
                "      - Be CONCRETE with experimental evidence!",
                "",
                "   h) **COLLECT PAPER TITLES** for this function:",
                ...
                "",
                "╔═══════════════════════════════════════════════════════════════╗",
                "║  GOLD STANDARD EXAMPLE (THIS IS THE QUALITY WE EXPECT!)     ║",
                "╚═══════════════════════════════════════════════════════════════╝",
                "",
                "Function: 'ATXN3 Protein Stability'",
                "arrow: 'activates'",
                "likely_direction: 'primary_to_main'  // RAD23A acts ON ATXN3",
                "cellular_process: 'RAD23A (HR23A), a ubiquitin receptor that shuttles substrates to",
                "  the proteasome, directly interacts with ATXN3 via the Ubiquitin-binding site 2 (UbS2)",
                "  on ATXN3's N-terminal Josephin domain. This interaction prevents ATXN3 from being",
                "  efficiently processed by the 26S proteasome. Rather than facilitating degradation,",
                "  RAD23A binding shields ATXN3 from proteasomal turnover.'",
                "effect_description: 'RAD23A binding to ATXN3 increases the stability and half-life of",
                "  the ATXN3 protein. This shields ATXN3 from proteasomal degradation, leading to",
                "  elevated steady-state ATXN3 protein levels in the cell.'",
                "biological_consequence: [",
                "  'RAD23A binds ATXN3 via UbS2 domain → Complex prevents 26S proteasome processing →",
                "   Proteasomal degradation of ATXN3 inhibited → Increased half-life and stabilization",
                "   of ATXN3 protein levels',",
                "  'Cellular stress → RAD23A-ATXN3 complex formation → ATXN3 shielded from degradation →",
                "   Maintained deubiquitinase activity → Preserved protein quality control'",
                "]",
                "specific_effects: [",
                "  'The interaction with Rad23 through UbS2 inhibits the degradation of Ataxin-3',",
                "  'Knockdown of Rad23 in cultured cells and in Drosophila results in lower levels of",
                "   ataxin-3 protein',",
                "  'Disrupting the UbS2 interaction decreases ATXN3 half-life',",
                "  'Ataxin-3 turnover does not require its ubiquitination but is regulated by UbS2'",
                "]",
                "",
                "NOTE: Paper titles don't ALL need query name - just need to discuss the mechanism!",
                "",
                "╔═══════════════════════════════════════════════════════════════╗",
                "║  QUALITY CHECKLIST (VERIFY BEFORE RETURNING!)                ║",
                "╚═══════════════════════════════════════════════════════════════╝",
                "",
                "For EACH function entry, verify:",
                "[ ] cellular_process is >= 2 sentences with molecular detail (domains, residues, modifications)",
                "[ ] effect_description is >= 2 sentences describing functional outcome",
                "[ ] biological_consequence has >= 2 multi-step cascades with → arrows",
                "[ ] specific_effects has >= 3 concrete experimental observations from literature",
                "[ ] evidence has >= 2 paper titles with years",
                "[ ] likely_direction is set ('main_to_primary' or 'primary_to_main')",
                "",
                "If ANY function fails this checklist, research MORE and fill it in!",
                "",
    ...
    StepConfig(
        ...
        prompt_template=(
            ...
            + "\n".join([
                ...
                "   - Or do they mutually affect each other in DIFFERENT ways? (= truly bidirectional)",
                "",
                ...
                "",
                "╔═══════════════════════════════════════════════════════════════╗",
                "║  BIDIRECTIONAL RULE (STRICT!)                                 ║",
                "╚═══════════════════════════════════════════════════════════════╝",
                "",
                "DO NOT use 'bidirectional' at the FUNCTION level. EVER.",
                ...
                "   - NEVER use 'bidirectional' at function level",
                "",
                ...
                "  'interaction_direction': 'main_to_primary' | 'primary_to_main',  // NEVER 'bidirectional'",
                ...
                "}",
                "",
                "NOTE: Interactor-level 'direction' CAN be 'bidirectional' if functions",
                "span BOTH directions. But each individual function MUST have a single direction.",
                "",
